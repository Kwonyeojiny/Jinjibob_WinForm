...
{
    public partial class _4_스토리 : Form
    {
        ...
        private void _4_스토리_Load(object sender, EventArgs e)
        {
            Storytimer.Enabled = true;
        }

        private void StoryGameTimer_4(object sender, EventArgs e)
        {
            ...
            if (player.Bounds.IntersectsWith(door.Bounds)) // 문에 캐릭터가 닿으면 다음 폼 
            {
                ...
                _5_game_벽피하기 form = FormOpen.OpenForm<_5_game_벽피하기>(this, currentPlayer);
                _5_게임설명 explain = FormOpen.MidOpenForm<_5_게임설명>(this);
            }
        }
